...
export default function About() {
  ...
  function splitArrayIntoGroups(arr: AboutWork[], numGroups: number) {
  ...
  const groupedArray = splitArrayIntoGroups(aboutWorkData, 4)
  ...
  return (
      ...
      <div className="about" ref={aboutArea}>
        <div className="about__intro">
          <div className="about__intro-top">
            ...
            <div className="about__intro-top-right">
              <svg
                className="about-svg"
                version="1.1"
                id="Layer_1"
	...
	C14.6,333.39,11.47,314.88,11.46,299.15z"
        ...
        <div className="about__content">
          {groupedArray.map((workBlock, index) => (
            <div key={index} className="about__content-row">
              <div className="about-items-left">
                {workBlock.slice(0, 2).map((work, index) => (
                  <div
                    key={work.id}
                    className={`about-item about-item-${index}`}
                  >
              ...
              {workBlock[2] && (
                <div className="about-item-right">
                  <div
                    key={workBlock[2].id}
                    className="about-item about-item-2"
                  >
                    <img
                      src={workBlock[2].images}
                      alt=""
                    ...
                    <div className="about-item__content">
                      <div className="about-item__left">
                        ...
                        <h3 className="about-item-subtitle">
                          {workBlock[2].subtitle}
                        </h3>
                      </div>
                      <div className="about-item__right">
                        <p className="about-item-date">{workBlock[2].year}</p>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <path  d="M 481.683 19.216 C 481.683 19.216 417.629 226.75 249.809 155.01 C 81.989 83.27 103.767 248.528 215.22 297.208 C 326.673 345.888 484.245 581.606 276.711 475.277 C 69.177 368.948 110.172 568.795 240.841 620.038"/>
</svg>
      </div> */}
    </>
  )
